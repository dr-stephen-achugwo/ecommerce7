...
const Terms: NextPageWithLayout = () => {
  ...
  return (
    <>
      <PageSeo description="" ogImageUrl={config.defaultOGImage} path={paths.terms} title="Terms" />
      <div className="pt-2" />
      <ContentWrapper>
        <Prose>
          <Heading isAutoFocus>{t.terms}</Heading>
          <Border />
          <Section>
            <div className="py-2 text">
              <p>
                この利用規約（以下，「本規約」といいます。）は，{config.name}
                （以下，「当社」といいます。）がこのウェブサイト上で提供するオンラインショップ（以下，「本サービス」といいます。）の利用条件を定めるものです。登録ユーザーの皆さま（以下，「ユーザー」といいます。）には，本規約に従って，本サービスをご利用いただきます。
              </p>
              ...
              <Heading>第7条（本サービスの提供の停止等）</Heading>
              <ol>
                <li>
              ...
              <Heading>第8条（利用制限および登録抹消）</Heading>
              <ol>
                <li>
              ...
              <Heading>第9条（退会）</Heading>
              <p>ユーザーは，所定の退会手続により，本サービスから退会できるものとします。</p>
              <Heading>第10条（保証の否認および免責事項）</Heading>
              <ol>
                <li>
              ...
              <Heading>第11条（サービス内容の変更等）</Heading>
              <p>
                当社は，ユーザーに通知することなく，本サービスの内容を変更しまたは本サービスの提供を中止することができるものとし，これによってユーザーに生じた損害について一切の責任を負いません。
              </p>
              <Heading>第12条（利用規約の変更）</Heading>
              <p>
                当社は，必要と判断した場合には，ユーザーに通知することなくいつでも本規約を変更することができるものとします。なお，本規約の変更後，本サービスの利用を開始した場合には，当該ユーザーは変更後の規約に同意したものとみなします。
              </p>
              <Heading>第13条（個人情報の取扱い）</Heading>
              <p>
                当社は，本サービスの利用によって取得する個人情報については，当社「プライバシーポリシー」に従い適切に取り扱うものとします。
              </p>
              <Heading>第14条（通知または連絡）</Heading>
              <p>
                ユーザーと当社との間の通知または連絡は，当社の定める方法によって行うものとします。当社は,ユーザーから,当社が別途定める方式に従った変更届け出がない限り,現在登録されている連絡先が有効なものとみなして当該連絡先へ通知または連絡を行い,これらは,発信時にユーザーへ到達したものとみなします。
              </p>
              <Heading>第15条（権利義務の譲渡の禁止）</Heading>
              <p>
                ユーザーは，当社の書面による事前の承諾なく，利用契約上の地位または本規約に基づく権利もしくは義務を第三者に譲渡し，または担保に供することはできません。
              </p>
              <Heading>第16条（準拠法・裁判管轄）</Heading>
              <ol>
...
Terms.getLayout = (page): JSX.Element => <Layout>{page}</Layout>
