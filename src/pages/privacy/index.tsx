...
const Privacy: NextPageWithLayout = () => {
  ...
  return (
    <>
      <PageSeo description="" ogImageUrl={config.defaultOGImage} path={paths.privacy} title="Privacy" />
      <div className="pt-2" />
      <ContentWrapper>
        <Prose>
          <Heading isAutoFocus>{t.privacy}</Heading>
          <Border />
          <Section>
            <div className="py-2 text">
              ...
              <Heading>第9条（プライバシーポリシーの変更）</Heading>
              <ol>
                <li>
...
Privacy.getLayout = (page): JSX.Element => <Layout>{page}</Layout>
